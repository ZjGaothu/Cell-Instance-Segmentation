...
def get_args():
    ...
    parser.add_argument("--img_dir", help="data directory", default="/home/gaozijing/gzj/PRseg/data/dataset2/trainuint8/", type=str)
    parser.add_argument("--mask_dir", help="data directory", default="/home/gaozijing/gzj/PRseg/data/dataset2/train_GT/mask_bin_ero/", type=str)
    parser.add_argument("--modelname", help="model name", default="u2netdata2", type=str)
...
np.savetxt('ioudata2.txt',ious_,fmt="%3f", delimiter="\t")
np.savetxt('dicedata2.txt',dice_,fmt="%3f", delimiter="\t")
np.savetxt('lossdata2.txt',losse_,fmt="%3f", delimiter="\t")
